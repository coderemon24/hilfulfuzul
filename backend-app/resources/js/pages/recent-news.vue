  ...
  <div class="py-8 pb-0">
    <div class="container w-11/12 mx-auto">
      ...
      <div class="breadcrumb flex items-center gap-2 text-sm mb-6">
        ...
        <span class="text-gray-600">সাম্প্রতিক সংবাদ</span>
      </div>
      <!---page title-->
      <div class="content bg-white p-3 rounded-lg shadow">
        <h1 class="text-2xl font-bold text-gray-800 text-center">সাম্প্রতিক সংবাদ</h1>
      </div>
      <!----- page contents ----->
      <div class="
      py-5
      ">
        ...
        md:justify-center
        ">
            <NewsCard v-for="card in 5" :key="card" class="
