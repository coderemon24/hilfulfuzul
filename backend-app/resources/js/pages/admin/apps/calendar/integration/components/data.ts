...
import googleMail from '@/assets/admin/images/app-calendar/google-mail.png'
import googleAnalytics from '@/assets/admin/images/app-calendar/google-analytics.png'
import googleMeet from '@/assets/admin/images/app-calendar/google-meet.png'
import intercom from '@/assets/admin/images/app-calendar/intercom.png'
import microsoftOutlook from '@/assets/admin/images/app-calendar/microsoft-outlook.png'
import googleChrome from '@/assets/admin/images/app-calendar/google-chrome.png'
import hubspot from '@/assets/admin/images/app-calendar/hubspot.png'
import stripe from '@/assets/admin/images/app-calendar/stripe.png'
import slack from '@/assets/admin/images/app-calendar/slack.png'
import salesForce from '@/assets/admin/images/app-calendar/sales-force.png'
import webHooks from '@/assets/admin/images/app-calendar/web-hooks.png'
import facebook from '@/assets/admin/images/app-calendar/facebook.png'
import microsoftTeamConference from '@/assets/admin/images/app-calendar/microsoft-team-conference.png'
import zapier from '@/assets/admin/images/app-calendar/zapier.png'
import zoom from '@/assets/admin/images/app-calendar/zoom.png'
